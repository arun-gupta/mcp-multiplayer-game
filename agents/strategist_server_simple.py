#!/usr/bin/env python3
"""
Simplified Strategist Agent MCP Server
...
class SimplifiedStrategistServer:
    """Simplified Strategist MCP Server using standard MCP protocol"""
    
    def __init__(self, port=3002):
        self.port = port
        self.agent = None
        self.server = Server("strategist-mcp-server")
        self.app = None
